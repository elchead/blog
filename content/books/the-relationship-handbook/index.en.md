...
{{< callout emoji="💭" text="The advice is mostly targeted at long married couples. The authors are convinced that you can be happy with anyone. Since we are not living in severe scarcity, I think it's good to set the bar higher. The truth is that life will be smoother and more enjoyable with some than with others. The tricky part is finding the sweet spot between accepting the next best and never settling. For the nerds among us, the statistically optimal solution to the stopping problem is to accept the next top pick after 37% of candidates. That solution indicates that you should start to commit rather early." >}}
